  ...
  async fetch(request: Request) {
    ...
    try {
      ...
      const html = '<!doctype html><html><body style="margin:0;background:#f3f7f8;font-family:Arial,Helvetica,sans-serif;color:#183c47">' +
        ...
        '<tr><td style="padding:20px 30px;background:#0c4d58"><table role="presentation" cellspacing="0" cellpadding="0"><tr><td style="width:72px;height:72px;border-radius:36px;background:#ffffff;text-align:center;vertical-align:middle"><img src="' + logoUrl + '" width="56" alt="Simplicon Tax Advisors" style="display:inline-block;width:56px;max-width:56px;height:auto;border:0"></td></tr></table></td></tr><tr><td style="height:5px;background:#16a184;font-size:0;line-height:0">&nbsp;</td></tr>' +
