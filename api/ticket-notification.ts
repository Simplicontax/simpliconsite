...
function renderEmail(ticket: Ticket, event: EmailEvent, actor: Profile, recipient: Profile, portalUrl: string, seq: string): { subject: string; html: string; text: string } {
  ...
  const html = '<!doctype html><html><body style="margin:0;background:#f3f7f8;font-family:Arial,Helvetica,sans-serif;color:#183c47">' +
    ...
    '<tr><td style="padding:20px 30px;background:#0c4d58"><table role="presentation" cellspacing="0" cellpadding="0"><tr><td style="width:72px;height:72px;border-radius:36px;background:#ffffff;text-align:center;vertical-align:middle"><img src="' + escapeHtml(logoUrl) + '" width="56" alt="Simplicon Tax Advisors" style="display:inline-block;width:56px;max-width:56px;height:auto;border:0"></td></tr></table></td></tr>' +
    ...
    '<a href="' + escapeHtml(ticketUrl) + '" style="display:inline-block;padding:13px 20px;border-radius:8px;background:#117d70;color:#fff;text-decoration:none;font-size:14px;font-weight:700">Open secure workspace</a><p style="margin:22px 0 0;font-size:13px;line-height:1.65;color:#45616a"><strong>Want to respond?</strong> Reply directly to this email to add a message to this ticket, or comment securely in the workspace. Please keep the existing subject line when replying.</p><p style="margin:18px 0 0;font-size:12px;line-height:1.6;color:#71868c">For your privacy, documents are never attached to notification emails.</p></td></tr>' +
